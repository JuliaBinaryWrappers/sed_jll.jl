...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import sed_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("8ce03227-cf0a-51af-b0b4-2693c0743e9f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "sed", artifacts_toml) for e in artifacts["sed"]]
...
if best_platform === nothing
    @debug("Unable to load sed; unsupported platform $(triplet(platform_key_abi()))")
else
